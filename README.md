...
## ⚠️ Notes
Some paths (like Chrome executable) are Windows-specific.
Update them if you are using another OS.
...
- [@Twitter](https://twitter.com/ShariarAlways/) 
- [@Instagram](https://instagram.com/shahriar_thebrowncat/) 
