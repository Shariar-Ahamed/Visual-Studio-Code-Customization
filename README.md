...
| ⚙️ **Productivity & Git** | GitHub Actions, GitLens, Git Graph, Todo Tree, WakaTime, Path & npm Intellisense | [View List](https://github.com/Shariar-Ahamed/Visual-Studio-Code-Customization/blob/main/extensions/extensions-list.md#productivity--workflow) |
